            ...
            switch (record.r_status) {
              case 4:
                if (record.can_edit == 1) {
                  if (record.is_fast == 1) {
                    go_path = `draft/quickPost?d_id=${record.id}&can_edit=true`;
                  } else {
                    go_path = `/draft/addDraft?d_id=${record.id}&type=1&can_edit=true`;
                  }
                } else {
              ...
              case 8:
                if (record.is_fast == 1) {
                  ...
                  go_path = `/draft/addDraft?d_id=${record.id}&type=1`;
                }
                break;
              default:
                go_path = `/home/incoming?id=${record.id}&file_type=1`;
