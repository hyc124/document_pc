    ...
    <a-timeline>
      <template v-for="(item,index) in data_list">
        <a-timeline-item :key="index">
          ...
          <div class="liuc-dian">
            <img src="../../../../../assets/addpostset/liiucheng-dian.png" alt />
          </div>
          <div class="trend-item">
            <div class="trend-item-top">
              <span>{{item.title}}</span>
              <div class="trend-item-isshow hand" @click="isshow(index)">
            ...
            <collapse-transition>
              <div class="collapse-wrap" v-show="item.isshow">
                <slot>
                  <div class="trend-item-bottom" v-if="item.info">
                    <div
                      class="trend-item-bottom-cl"
