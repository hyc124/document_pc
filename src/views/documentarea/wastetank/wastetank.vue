...
export default {
  ...
  data() {
    return {
      ...
      tabsarry: [
        { name: "发文废弃箱", value: 1, icon: "分发发文" },
        { name: "收文废弃箱", value: 2, icon: "分发收文" },
        { name: "签报废弃箱", value: 3, icon: "分发收文" }
      ],
      columns_list: [
        [
          // 表单格式
