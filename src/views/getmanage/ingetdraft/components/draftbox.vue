<template>
  <div class="advance">
    <div class="advance-topbtnbox flex-col">
      ...
      <a-button v-if="powers('get_print')" @click="batchPrinting(1)">批量打印</a-button>
    </div>
      ...
      >
        ...
        <span slot="operation" slot-scope="item,record">
          <div class="flex-col operation">
            <!-- <div class="hand mr10" @click="editclick(record,1)">编辑</div> -->
            <div
              class="hand"
              v-if="powers('get_delete')"
              style="color:#F56C6C;"
