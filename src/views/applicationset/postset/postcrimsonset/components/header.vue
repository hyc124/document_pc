...
export default {
  ...
  methods: {
    ...
    onInquire() {
      ...
      this.$bus.$emit("postpostcrimsInquire", 1);
      this.inquireloadcrims();
    },
    // 查询套红模板
    inquireloadcrims() {
